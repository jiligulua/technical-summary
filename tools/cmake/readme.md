...
set_prorperty(TARGET mylib PROPERTY RUNTIME_OUTPUT_DIRECTORY_RELEAE ${PROJECT_BINARY_DIR}) set_prorperty(TARGET mylib PROPERTY ARCHIVE_OUTPUT_DIRECTORY_RELEASE ${PROJECT_BINARY_DIR}) set_prorperty(TARGET mylib PROPERTY LIBRARY_OUTPUT_DIRECTORY_RELEASE ${PROJECT_BINARY_DIR}) 
